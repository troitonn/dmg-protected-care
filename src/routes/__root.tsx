...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Medicina do trabalho, PCMSO, PGR, laudos, eSocial SST e NR-1 para empresas em Franca-SP. Elo entre segurança jurídica e acolhimento humanizado." },
      { name: "author", content: "DMG Ocupacional" },
      { property: "og:title", content: "DMG Ocupacional — Medicina do Trabalho em Franca-SP" },
      { property: "og:description", content: "Proteção empresarial em saúde ocupacional, segurança jurídica e gestão de riscos trabalhistas." },
